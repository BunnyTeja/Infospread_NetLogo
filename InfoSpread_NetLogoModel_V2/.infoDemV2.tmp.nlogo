...
if not file-exists? "donovianAgentsInput.csv" [
user-message "No file 'donovianAgentsInput.csv' exists."
stop
]

file-open "donovianAgentsInput.csv" ; open the file with the turtle data
let data csv:from-row file-read-line
; We'll read all the data in a single loop
  let i 0
while [ i < nb-donovian-agents] [
